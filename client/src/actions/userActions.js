...
export const authenticateUser = (username, password) => {
    return async (dispatch, getState) => {
        const response = await paperclips.get("/users/authentication", {params: {
            username: username, 
            password: password
        }});
        dispatch({
...
export const fetchUserInformationByUsername = username => {
    return async (dispatch, getState) => {
        const response = await paperclips.get("/users/userInformationUsername", {params: {
            username: username
        }});
        dispatch({
...
export const fetchUserInformationById = userId => {
    return async (dispatch, getState) => {
        const response = await paperclips.get("/users/userInformationId", {params: {
            id: userId
        }});
        dispatch({
